...
public partial class SmartServeDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BrandEntity>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TenantId, e.Name }, "brands_tenant_id_name_key").IsUnique();

            entity.HasIndex(e => e.TenantId, "idx_brands_tenant");
            ...
            entity.HasOne(d => d.Tenant).WithMany(p => p.Brands)
                .HasForeignKey(d => d.TenantId)
                .HasConstraintName("brands_tenant_id_fkey");
        });
        ...
        modelBuilder.Entity<CategoryEntity>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TenantId, e.Name }, "categories_tenant_id_name_key").IsUnique();

            entity.HasIndex(e => e.TenantId, "idx_categories_tenant");
        ...
        modelBuilder.Entity<OrderEntity>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TenantId, e.CreatedAt }, "idx_orders_tenant_created");

            entity.HasIndex(e => new { e.TenantId, e.OrderNumber }, "orders_tenant_id_order_number_key").IsUnique();
        ...
        modelBuilder.Entity<OrderItemEntity>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TenantId, e.OrderId }, "idx_order_items_tenant_order");
            ...
            entity.HasOne(d => d.Tenant).WithMany(p => p.OrderItems)
                .HasForeignKey(d => d.TenantId)
                .HasConstraintName("order_items_tenant_id_fkey");
        ...
        modelBuilder.Entity<PaymentEntity>(entity =>
        {
            ...
            entity.HasIndex(e => e.TenantId, "idx_payments_tenant");
        ...
        modelBuilder.Entity<ProductEntity>(entity =>
        {
            ...
            entity.HasIndex(e => e.TenantId, "idx_products_tenant");
        ...
        {
            entity.HasKey(e => new { e.TenantId, e.ProductVariantId, e.IngredientVariantId }).HasName("product_ingredients_pkey");
            ...
            entity.HasOne(d => d.Tenant).WithMany(p => p.ProductIngredients)
                .HasForeignKey(d => d.TenantId)
                .HasConstraintName("product_ingredients_tenant_id_fkey");
        });
        ...
        modelBuilder.Entity<ProductVariantEntity>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TenantId, e.ProductId }, "idx_variants_tenant_product");

            entity.HasIndex(e => new { e.TenantId, e.ProductId, e.BrandId, e.VariantName }, "product_variants_tenant_id_product_id_brand_id_variant_name_key").IsUnique();
            ...
            entity.HasOne(d => d.Tenant).WithMany(p => p.ProductVariants)
                .HasForeignKey(d => d.TenantId)
                .HasConstraintName("product_variants_tenant_id_fkey");
        });
        ...
        modelBuilder.Entity<RestaurantTableEntity>(entity =>
        {
            ...
            entity.HasIndex(e => e.TenantId, "idx_tables_tenant");
            ...
            entity.HasOne(d => d.Tenant).WithMany(p => p.RestaurantTables)
                .HasForeignKey(d => d.TenantId)
                .HasConstraintName("restaurant_tables_tenant_id_fkey");
        });
        ...
        modelBuilder.Entity<RoleEntity>(entity =>
        {
            ...
            entity.HasMany(d => d.Permissions).WithMany(p => p.Roles)
                .UsingEntity<Dictionary<string, object>>(
                    "RolePermission",
                    r => r.HasOne<PermissionEntity>().WithMany()
        ...
        modelBuilder.Entity<StockEntity>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TenantId, e.VariantId }, "idx_stock_tenant_variant");

            entity.HasIndex(e => new { e.TenantId, e.ItemType, e.VariantId }, "stock_tenant_id_item_type_variant_id_key").IsUnique();
            ...
            entity.HasOne(d => d.Tenant).WithMany(p => p.Stocks)
                .HasForeignKey(d => d.TenantId)
                .HasConstraintName("stock_tenant_id_fkey");
        ...
        modelBuilder.Entity<StockTransactionEntity>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TenantId, e.CreatedAt }, "idx_stock_tx_tenant_created");
            ...
            entity.HasOne(d => d.Tenant).WithMany(p => p.StockTransactions)
                .HasForeignKey(d => d.TenantId)
                .HasConstraintName("stock_transactions_tenant_id_fkey");
        });
        ...
        modelBuilder.Entity<TenantEntity>(entity =>
        {
            ...
            entity.Property(e => e.Name)
                .HasMaxLength(150)
                .HasColumnName("name");
            entity.Property(e => e.OrderCounter)
                .HasDefaultValue(1)
                .HasColumnName("order_counter");
        ...
        modelBuilder.Entity<UserEntity>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.TenantId, e.Username }, "ux_users_tenant_username").IsUnique();
